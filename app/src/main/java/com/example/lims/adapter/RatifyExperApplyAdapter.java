 ...
 */
public class RatifyExperApplyAdapter extends RecyclerView.Adapter<RatifyExperApplyAdapter.ViewHolder> {
    ...
    public RatifyExperApplyAdapter(List<ReservationData.DataBean> list) {
        this.list = list;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View dataView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_experiment_apply_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        if (position != list.size()) {
            ...
            holder.date.setText(DateUtil.getTimeShort(item.getCourseTime()));
